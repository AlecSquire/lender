...
const LenderLogo = ({ className }) => (
    ...
    >
        ...
        <path
            d="M18 30C18 30 22 26 30 26C38 26 42 30 22 30"
            stroke="#000000"
            strokeWidth="4"
            strokeLinecap="round"
        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="text-center">
                            ...
                            <p className="text-gray-400">
                                Track items and money lent or borrowed with just
                                a few clicks.
                            </p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-gray-400">
                                Automated notifications ensure no one forgets.
                            </p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-gray-400">
                                No subscriptions, no fees—just peace of mind.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    {[1, 2, 3].map((step) => (
                        <div key={step} className="border border-gray-800 p-8">
                            ...
                            <p className="text-gray-400">
                                ...
                                {step === 2 &&
                                    "Easily log what you've lent or borrowed with a few taps."}
                                {step === 3 &&
                                    "Sit back as Lender tracks and reminds about your stuff."}
                            </p>
                        </div>
                    ))}
                </div>
            ...
            <section className="container mx-auto px-4 py-24">
                ...
                <div className="border border-gray-800 p-8 max-w-2xl mx-auto">
                    <ul className="list-disc list-inside space-y-2 text-gray-400">
                        ...
                        <li>
                            Public shaming feature for overdue items (opt-in
                            only!)
                        </li>
                        <li>
                            Cash lender feature with built-in interest
                            calculator
                        </li>
                    </ul>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {[
                            ...
                            },
                            {
                                title: "Laravel News",
                                description:
                                    "Laravel News is a community driven portal and newsletter aggregating all of the latest Laravel news.",
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="mb-8 md:mb-0 text-center md:text-left">
                            <p className="text-lg font-semibold">
                                Lender – Because Every Borrow Counts
                            </p>
